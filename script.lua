...
-- ================================================
local ITEM_NAMES = {
    ["rbxassetid://92541145782702"] = "Blue Bell Token", -- replace with actual name
...
-- ================================================
-- Helper: parse quantity text like "x46.7k" -> 46700
-- ================================================
local function parseQuantity(text)
    text = text:lower():gsub("x", "")
...
local function sniperScan()
    ...
    for _, boothModel in ipairs(boothsFolder:GetChildren()) do
        ...
        for _, itemFrame in ipairs(petScroll:GetChildren()) do
            ...
            local qty = quantityLabel and parseQuantity(quantityLabel.Text) or 0
            ...
            if price <= MAX_PRICE and qty > 0 then
                -- The UUID is just the frame's name!
